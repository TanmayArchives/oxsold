  ...
  const itemsUser = [
    {
      key: '/user/:id/address',
      label: 'My Addresses',
      onClick: () => goToUserPage('/user/:id/address'),
    },

    {
      key: '/user/:id/add-address',
      label: 'Add New Address',
      onClick: () => goToUserPage('/user/:id/add-address'),
    },

    {
      key: '/user/:id/edit-address/:addressId',
      label: 'My Addresses',
      onClick: () => goToUserPage('/user/:id/edit-address/:addressId'),
    },
  ]
